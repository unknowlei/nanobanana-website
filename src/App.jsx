 ...
 * ==============================================================================
 */
const DATA_SOURCE_URL = "https://raw.githubusercontent.com/unknowlei/nanobanana-data/refs/heads/main/data%20(66).json";
...
export default function App() {
  ...
  // 🔴 上次访问时间 (Last Visit Time Logic) - 懒加载初始化，避免闪烁
  const [lastVisit, setLastVisit] = useState(() => {
      const storedLastVisit = localStorage.getItem('nanobanana_last_visit');
      if (storedLastVisit) {
          return parseInt(storedLastVisit, 10);
      }
      // 如果没有记录（新人），直接返回当前时间，让所有旧内容都不显示 NEW
      return Date.now();
  });
